...
test_that("movement function throws an error if given the wrong flux type", {
  ...
  expect_error(movement(locationdataframe, movement_matrix, "original radiation"),"Error: Unknown flux model type given. The input 'flux_model' has to be a flux object.")
})
